                        ...
                        <div class="col s12">
                            <div id="clendar" class="card">
                                <div class="card-content">
                                    ...
                                    <div>
                                        {!! Form::open(array('method' => 'POST', 'url' => 'admin/files/storepassword', 'id' => 'fileupload', 'class' => 'form-horizontal form-bordered form-validate', 'role' => 'form', 'files' => true, 'enctype' => 'multipart/form-data')) !!}
                                        @include('admin.forms.zip', ['submit' => 'Dodaj'])
                                        {!! Form::close() !!}
